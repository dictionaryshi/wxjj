...
import com.wx.dao.warehouse.model.OrderItemDOExample.Criteria;
import com.wx.dao.warehouse.model.OrderItemDOExample.Criterion;
...
public class OrderItemDOSqlProvider {
    public String countByExample(OrderItemDOExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(OrderItemDOExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(OrderItemDO record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(OrderItemDOExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        OrderItemDO record = (OrderItemDO) parameter.get("record");
        OrderItemDOExample example = (OrderItemDOExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(OrderItemDO record) {
        SQL sql = new SQL();
        sql.UPDATE("order_item");
    ...
    protected void applyWhere(SQL sql, OrderItemDOExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
